...
struct Home: View {
    ...
    private let sunWaterGradient : Gradient = Gradient(stops: [
    ...
    private let midWaterGradient : Gradient = Gradient(stops: [
    ...
    private let deepWaterGradient : Gradient = Gradient(stops: [
    ...
    var body: some View {
        ZStack{
            ...
            LinearGradient(gradient: sunWaterGradient, startPoint: .top, endPoint: .bottom).opacity(waterLevel == .SunLevel ? 1 : 0)
            LinearGradient(gradient: midWaterGradient, startPoint: .top, endPoint: .bottom).opacity(waterLevel == .MidWaterLevel ? 1 : 0)
            LinearGradient(gradient: deepWaterGradient, startPoint: .top, endPoint: .bottom).opacity(waterLevel == .DeepWaterLevel ? 1 : 0)
...
//            }
    ...
    func moveOffSet(){
        withAnimation(.easeOut(duration: 2.5)){
            ...
            switch waterLevel {
            case .SunLevel:                waterLevel = .MidWaterLevel
                smaleView.play()
