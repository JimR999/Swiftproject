...
//  BooNap
//
//  Created by jamil raai on 15.10.21.
//
...
struct ScrollableView<Content: View>: UIViewControllerRepresentable, Equatable {
    ...
    // MARK: - Init
    init(_ offset: Binding<CGPoint>, animationDuration: TimeInterval, showsScrollIndicator: Bool = false, axis: Axis = .vertical, onScale: ((CGFloat)->Void)? = nil, disableScroll: Bool = true, forceRefresh: Bool = true, stopScrolling: Binding<Bool> = .constant(false),  @ViewBuilder content: @escaping () -> Content) {
        self.offset               = offset
